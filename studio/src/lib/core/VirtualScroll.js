...
export default class VirtualScroll {
  constructor($container, options = {}) {
    const { itemHeight = 50, bufferSize = 5, renderItem = null, onRender = null, itemsClass = '' } = options;
  ...
  _createDOM() {
    ...
    this.$viewport.style.cssText = 'height:100%;overflow-y:auto;overflow-x:hidden;position:relative;';
    ...
    this.$items.style.cssText = 'position:absolute;top:0;left:0;right:0;margin:0;padding:0;list-style:none;';
  ...
  _getVisibleRange() {
    ...
    const end = Math.min(items.length - 1, binarySearchEnd(offsets, scrollTop + viewportHeight) + bufferSize);
