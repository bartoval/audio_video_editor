...
export const createElement = (tag, config = {}) => {
  const { className, id, text, html, attributes = {}, styles = {}, listeners = {}, parent } = config;
...
export const createIconButton = ({ icon, title, onClick, variant = 'outline-info', size = 'sm', parent }) => {
  return createButton({
